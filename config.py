...
class Config:
    ...
    BOT_SESSION = environ.get("BOT_SESSION", "Djdjsjdjdkdkektndbot") 
    ...
    LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002360620662'))
    FORCE_SUB_CHANNEL = environ.get("FORCE_SUB_CHANNEL", "-1002423978246") 
